...
} from "./chunk-YA546FZ4.js";
import {
  Axis,
  FromHalfFloat,
  SphericalPolynomial
} from "./chunk-ZFOG4D4F.js";
import {
  BoundingInfo,
  SubMesh
} from "./chunk-DRQBTNSR.js";
import {
  extractMinAndMax
} from "./chunk-KSSWZKOU.js";
import {
  Node
} from "./chunk-Q2LMM5PO.js";
import {
  PickingInfo
} from "./chunk-FDLOFTXU.js";
import {
  PerfCounter
} from "./chunk-LJSODA3L.js";
import {
  UniformBuffer
} from "./chunk-ADPWUPNY.js";
import {
  SerializationHelper
} from "./chunk-YMG4SQOJ.js";
import {
  Color3,
  Color4
} from "./chunk-LU674LN5.js";
import {
  GetTypeForDepthTexture,
  HasStencilAspect,
  IsWrapper
} from "./chunk-3NFBO5BD.js";
import {
  Buffer,
  VertexBuffer
} from "./chunk-MCOSY44R.js";
import {
  __decorate,
  nativeOverride,
  serialize,
...
import {
  EngineStore
} from "./chunk-EBQ36XFT.js";
import {
  AbstractAudioNode,
  _WebAudioParameterComponent
} from "./chunk-ZGQUVYKV.js";
import {
  Observable
...
var WebGPUShaderProcessor = class _WebGPUShaderProcessor {
  ...
  _addTextureBindingDescription(name3, textureInfo, textureIndex, dimension, format, isVertex, storageTextureAccess = "write-only") {
  ...
  textureProcessor(texture, isFragment, preProcessors) {
    ...
    if (match !== null) {
      ...
      for (let i = 0; i < arraySize; ++i) {
        ...
        this._addTextureBindingDescription(name3, textureInfo, i, textureDimension, storageTextureFormat, !isFragment, storageTextureAccess);
      }
    }
    return texture;
  }
...
AbstractEngine.prototype.createRenderPassId = function(name3) {
  const id = ++AbstractEngine._RenderPassIdCounter;
  this._renderPassNames[id] = name3 ?? "NONAME";
  return id;
};
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name3, options = {}) {
    const module = await import("./webAudioBus-A6ZND27F.js");
  ...
  async createMainBusAsync(name3, options = {}) {
    const module = await import("./webAudioMainBus-L4RGEXIS.js");
  ...
  async createSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStaticSound-E2577ICI.js");
  ...
  async createSoundSourceAsync(name3, source, options = {}) {
    const module = await import("./webAudioSoundSource-XIJAIA27.js");
  ...
  async createStreamingSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStreamingSound-OMISDUZL.js");
...
var WebGPUEngine = class _WebGPUEngine extends ThinWebGPUEngine {
  ...
  _initializeLimits() {
    ...
    this._caps = {
      ...
      supportReadWriteStorageTextures: typeof navigator !== "undefined" && ((_b = (_a = navigator.gpu) == null ? void 0 : _a.wgslLanguageFeatures) == null ? void 0 : _b.has("readonly_and_readwrite_storage_textures")) === true
    };
    this._features = {
...
//# sourceMappingURL=chunk-JPRIV4OJ.js.map
